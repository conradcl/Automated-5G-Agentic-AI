...
- No tool nodes are implemented yet. Brain 1 currently has no access to live testbed data. Wiring the existing xApp's E2 summary output into LangGraph is the next planned step.
